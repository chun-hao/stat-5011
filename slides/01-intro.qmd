...
-  [MIT 9.520](https://poggio-lab.mit.edu/9-520)
...
![](images/lec01/neuron.svg){fig-align="center" width=70%}
...
[^lecun1986]: LeCun, Y. (1986). Learning processes in an asymmetric threshold network, *Disordered systems and biological organizations*, Les Houches, France, Springer, pages 233-240.
...
-  Le Cun (1989)[^cnn] proposed concolutional network for data with grid-like structure, e.g., images.
